...
/**
 * Servlet implementation class AltaEmpleadoServletNew
 */
@WebServlet("/AltaEmpleadoServletNew")
public class AltaEmpleadoServletNew extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AltaEmpleadoServletNew() {
        super();
